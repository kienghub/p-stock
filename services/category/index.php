<!doctype html>
<html lang="en" ng-app="app" ng-controller="controller" ng-init="_callCategory();">
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">ປະເພດວຽກ</li>
                </ol>
            ...
            <div class="main-container">
                <div class="row">
                    ...
                    <div class="col-md-9 col-12">
                        <div class="blog p-3">
                            <h4><i class="fa fa-list"></i> ລາຍການປະເພດວຽກ </h4>
                            <hr>
                            <div class="table-responsice">
                                <table class="table table-hover table-sm" id="main">
                                    ...
                                    <tr ng-repeat="x in _categorys" id="sublist">
                                        ...
                                        <td ng-bind='x.cate_createdBy'></td>
                                        <td>
