<!doctype html>
<html lang="en" ng-app="app" ng-controller="controller" ng-init="_callProject()">
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">ໂຄງການ</li>
                </ol>
            ...
            <div class="main-container">
                <div class="row">
                    <div class="col-md-3 col-12">
                        <div class="blog p-3">
                            ...
                            <div class="form-group">
                                <label for="">ໂຄງການ <?php isVal()?></label>
                                <input type="hidden" class="form-control" ng-model="proj_id">
                                <input type="text" class="form-control" ng-model="proj_title"
                                    placeholder="ກະລຸນາປ້ອນໂຄງການ">
                            </div>
                            <div class="form-group">
                                <label for="">ໝາຍເຫດ</label>
                                <textarea rows="3" class="form-control" ng-model="proj_note"
                    ...
                    <div class="col-md-9 col-12">
                        <div class="blog p-3">
                            <h4><i class="fa fa-list"></i> ລາຍການໂຄງການ</h4>
                            <hr>
                            <div class="table-responsice">
                                <table class="table table-hover table-sm" id="main">
                                    ...
                                    <tr ng-repeat="x in _categorys" id="sublist">
                                        ...
                                        <td ng-bind='x.proj_title'></td>
                                        <td ng-bind='x.proj_note'></td>
                                        <td ng-bind='x.proj_createdAt'></td>
                                        <td ng-bind='x.proj_createdBy'></td>
                                        <td>
                                            <div class="btn-group float-right">
                                                <button type="button" ng-click="_onUpdate(x)"
                                                    class="btn btn-outline-primary"><i
                                                        class="fa fa-pencil"></i></button>
                                                <button type="button" ng-click="_onDelete(x.proj_id)"
