<!doctype html>
<html lang="en" ng-app="app" ng-controller="controller" ng-init="_callRank()">
            ...
            <div class="main-container">
                <div class="row">
                    <div class="col-md-3 col-12">
                        <div class="blog p-3">
                            ...
                            <div class="form-group">
                                <label for="">ຕຳແໜ່ງ <?php isVal()?></label>
                                <input type="hidden" class="form-control" ng-model="rank_id">
                                <input type="text" class="form-control" ng-model="rank_title"
                                    placeholder="ກະລຸນາປ້ອນຕຳແໜ່ງ">
                            </div>
                            <div class="form-group">
                                <label for="">ໝາຍເຫດ</label>
                                <textarea rows="3" class="form-control" ng-model="rank_note"
                    ...
                    <div class="col-md-9 col-12">
                        <div class="blog p-3">
                            <h4><i class="fa fa-list"></i> ລາຍການຕຳແໜ່ງ</h4>
                            <hr>
                            <div class="table-responsice">
                                <table class="table table-hover table-sm" id="main">
                                    ...
                                    <tr ng-repeat="x in _categorys" id="sublist">
                                        ...
                                        <td ng-bind='x.rank_title'></td>
                                        <td ng-bind='x.rank_note'></td>
                                        <td ng-bind='x.rank_createdAt'></td>
                                        <td ng-bind='x.rank_createdBy'></td>
                                        <td>
                                            <div class="btn-group float-right">
                                                <button type="button" ng-click="_onUpdate(x)"
                                                    class="btn btn-outline-primary"><i
                                                        class="fa fa-pencil"></i></button>
                                                <button type="button" ng-click="_onDelete(x.rank_id)"
